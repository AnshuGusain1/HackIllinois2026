...
AIN1 = 5    # Left motor direction 1
AIN2 = 22   # Left motor direction 2  (CHANGE THIS to your actual pin)
BIN1 = 6    # Right motor direction 1
BIN2 = 27   # Right motor direction 2 (CHANGE THIS to your actual pin)
